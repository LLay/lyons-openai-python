...
class Threads(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Args:
          messages: A list of [messages](https://platform.openailyon.com/docs/api-reference/messages) to
    ...
    def create_and_run(
        ...
        *,
        ...
        Args:
          ...
          model: The ID of the [Model](https://platform.openailyon.com/docs/api-reference/models) to
