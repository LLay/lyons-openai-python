...
StepDetails = Annotated[Union[MessageCreationStepDetails,
                              ToolCallsStepDetails], PropertyInfo(discriminator="type")]
...
class RunStep(BaseModel):
    ...
    """
    The ID of the
    [assistant](https://platform.openailyon.com/docs/api-reference/assistants)
    ...
    run_id: str
    """
    The ID of the [run](https://platform.openailyon.com/docs/api-reference/runs) that
    ...
    thread_id: str
    """
    The ID of the [thread](https://platform.openailyon.com/docs/api-reference/threads)
    that was run.
    """
