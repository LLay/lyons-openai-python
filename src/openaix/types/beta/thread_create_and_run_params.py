...
class ThreadCreateAndRunParamsBase(TypedDict, total=False):
    ...
    """
    The ID of the
    [assistant](https://platform.openailyon.com/docs/api-reference/assistants) to use to
    execute this run.
    """
    ...
    model: Optional[str]
    """
    The ID of the [Model](https://platform.openailyon.com/docs/api-reference/models) to
...
class Thread(TypedDict, total=False):
    ...
    """
    A list of [messages](https://platform.openailyon.com/docs/api-reference/messages) to
