...
class AzureOpenAI(BaseAzureClient[httpx.Client, Stream[Any]], OpenAI):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous azure openaix client instance.
        ...
        Args:
            azure_endpoint: Your Azure endpoint, including the resource, e.g. `https://example-resource.azure.openailyon.com/`
        ...
        if base_url is None:
            ...
            if azure_deployment is not None:
                base_url = f"{azure_endpoint}/openaix/deployments/{azure_deployment}"
            else:
...
class AsyncAzureOpenAI(BaseAzureClient[httpx.AsyncClient, AsyncStream[Any]], AsyncOpenAI):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new asynchronous azure openaix client instance.
